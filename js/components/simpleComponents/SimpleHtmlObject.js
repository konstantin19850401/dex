...
class SimpleHtmlObject {
	...
	#mayHaveChild = ['DIV', 'SELECT', 'H5', 'H2', 'H3', 'SPAN', 'FORM', 'BUTTON', 'INPUT', 'LABEL', 'NAV', 'UL', 'LI', 'A', 'I', 'SMALL', 'TABLE', 'TR', 'TH', 'SELECT', 'TBODY', 'THEAD', 'TD', 'TEXTAREA', 'STRONG', 'DEXDATE', 'DEXCOMBOBOX', 'CANVAS'];
